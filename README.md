...
| 工资 | 按月展示预估工资：底薪、平时/周末/节假日加班费、餐补、夜班补贴、全勤奖、请假扣款，并附计算规则；可导出明细 CSV、复制工资单文本 |
| 设置 | 底薪、月计薪天数（21.75）、每日标准工时（8）、加班倍率、餐补、夜班补贴、全勤奖、工时取整方式；数据备份/导入/清空 |
